...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='/home/zcs/code/deep-learning-for-image-processing-master/pytorch_object_detection/time_detr-main/weight_all/weight_res50_DA_ciou/checkpoint.pth', help='resume from checkpoint')
    # 权重输出位置。
    parser.add_argument('--output_dir', default='./weight_all/weight_res50_DA_ciou',
