...
def get_args_parser():
    ...
    # 检测结果保存路径
    parser.add_argument('--output_dir', default='/home/zcs/code/deep-learning-for-image-processing-master/predict_demo/output/res_ciou',
                        help='path where to save, empty for no saving')
    # 存放模型的位置
    parser.add_argument('--resume', default='./weight_all/weight_res50_ciou/test/checkpoint_best_epoch47.pth',
